...
namespace _3_by_3_any
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (; ; )
            {
                if (i < 50) //run the game until I've won 50 times.
                {
                    if (x == 2 && y == 2) //check if won
                    {
                        x = 0;
                        y = 0;
                        r = 0;
                    ...
                    else
                    {
                        ...
                        r++;
                        //Console.WriteLine("Times Rolled: {0}", r); //uncomment to output times rolled
                        ...
                        else if (y % 2 != 0 && y <= 2) //if y is not divisible by 2, odd number lines player moves left
                        {
                            if (x - Roll >= 0)
                            {
                                x -= Roll;
